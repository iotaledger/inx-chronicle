...
//! [`ProtocolParameters`](iota_sdk::types::block::protocol::ProtocolParameters).
    ...
    U: TryFromWithContext<T>,
{
    ...
    fn try_into_with_context(self, ctx: &iota_sdk::types::block::protocol::ProtocolParameters) -> Result<U, U::Error> {

...
pub struct RawMessage<T: Packable> {
    data: Vec<u8>,
...
impl<T: Packable> From<Vec<u8>> for RawMessage<T> {
...
impl From<proto::RawOutput> for RawMessage<bee_block_stardust::output::Output> {
    fn from(value: proto::RawOutput) -> Self {
        value.data.into()
    }
}

impl From<RawMessage<bee_block_stardust::output::Output>> for proto::RawOutput {
    fn from(value: RawMessage<bee_block_stardust::output::Output>) -> Self {
        Self { data: value.data }
    }
}

impl From<proto::RawBlock> for RawMessage<bee_block_stardust::Block> {
    fn from(value: proto::RawBlock) -> Self {
        value.data.into()
    }
}

impl From<RawMessage<bee_block_stardust::Block>> for proto::RawBlock {
    fn from(value: RawMessage<bee_block_stardust::Block>) -> Self {
        Self { data: value.data }
    }
}

impl From<proto::RawMilestone> for RawMessage<bee_block_stardust::payload::Payload> {
    fn from(value: proto::RawMilestone) -> Self {
        value.data.into()
    }
}

impl From<RawMessage<bee_block_stardust::payload::Payload>> for proto::RawMilestone {
    fn from(value: RawMessage<bee_block_stardust::payload::Payload>) -> Self {
        Self { data: value.data }
    }
}
...
mod test {
    ...
    fn raw_milestone() {
        ...
        let raw = RawMessage::<Payload>::from(data);

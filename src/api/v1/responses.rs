...
use crate::{api::responses::SuccessBody, types::LedgerInclusionState};
...
/// and GET /api/v1/transactions/<transaction_id>/included-message
...
/// Response of GET /api/v1/messages
#[derive(Clone, Debug, Serialize, Deserialize)]
...
/// Response of GET /api/v1/transactions/<message_id>
#[derive(Clone, Debug, Serialize, Deserialize)]
...
/// Response of GET /api/v1/transactions/ed25519/<address>
#[derive(Clone, Debug, Serialize, Deserialize)]
...
/// Response of GET /api/v1/milestone/<index>
#[derive(Clone, Debug, Serialize, Deserialize)]
...
/// Response of GET /api/v1/analytics/addresses[?start_timestamp=<u32>&end_timestamp=<u32>]
#[derive(Clone, Debug, Serialize, Deserialize)]

            ...
            match subcommand {
                ...
                Subcommands::FillAnalytics {
                    ...
                    for i in 0..num_tasks {
                        ...
                        let mut analytics_choices = if analytics.is_empty() {
                            influxdb::all_analytics()
                        } else {
                        ...
                        join_set.spawn(async move {
                            ...
                            let mut state: Option<crate::stardust_inx::AnalyticsState> = None;
                            ...
                            while let Some(milestone) = milestone_stream.try_next().await? {
                                    ...
                                    let analytics = analytics_choices
                                        ...
                                        .map(|choice| match choice {
                                            ...
                                            AnalyticsChoice::BaseTokenActivity => {
                                                Analytic::BaseTokenActivity(Default::default())
                                            }
                                            AnalyticsChoice::BlockActivity => {
                                                Analytic::BlockActivity(Default::default())
                                            }
                                ...
                                milestone.update_analytics(&mut state.as_mut().unwrap().analytics, &influx_db).await?;

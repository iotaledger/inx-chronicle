...
use chronicle::{
    ...
    runtime::{Actor, ActorContext, ActorError, Addr, HandleEvent, Report},
...
use self::{
    ...
    worker::{MessageRequest, MetadataRequest},
};
use super::{solidifier::Solidifier, Collector, CollectorError};

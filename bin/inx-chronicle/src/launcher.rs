...
impl Actor for Launcher {
    ...
    async fn init(&mut self, cx: &mut ActorContext<Self>) -> Result<Self::State, Self::Error> {
        ...
        #[cfg(feature = "api")]
        cx.spawn_child(crate::api::ApiWorker::new(db, config.api.clone())).await;

        #[cfg(feature = "metrics")]
        cx.spawn_child(crate::metrics::MetricsWorker::new(config.metrics.clone()))
            .await;
...
#[cfg(feature = "api")]
#[async_trait]
impl HandleEvent<Report<crate::api::ApiWorker>> for Launcher {
    async fn handle_event(
        &mut self,
        cx: &mut ActorContext<Self>,
        event: Report<crate::api::ApiWorker>,
        config: &mut Self::State,
    ) -> Result<(), Self::Error> {
        match event {
            Report::Success(_) => {
...
#[cfg(feature = "metrics")]
#[async_trait]
impl HandleEvent<Report<crate::metrics::MetricsWorker>> for Launcher {
    async fn handle_event(
        &mut self,
        cx: &mut ActorContext<Self>,
        event: Report<crate::metrics::MetricsWorker>,
        config: &mut Self::State,
    ) -> Result<(), Self::Error> {
        match event {
            Report::Success(_) => {
